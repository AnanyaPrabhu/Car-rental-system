...
.invalid:before {
 ...
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            id="name"  pattern="[A-Za-z]+" title="ex: Seema" placeholder="Enter Your First Name" required>
            <br><br>

            <label>Last Name : </label>
            <br>
            <input type ="text" name="lname"
            id="name"  pattern="[A-Za-z]+"  title="ex: Sharma" placeholder="Enter Your Last Name" required>
            <br><br>
